...
import { faUserCircle,faUser,faUserPlus } from "@fortawesome/free-solid-svg-icons";
...
export function Google(props){
    ...
    <section class="form">
          ...
          //buttonText="Login"
          render={renderProps => (
            <button className="buttons" onClick={renderProps.onClick} disabled={renderProps.disabled}><a className="usericon"><FontAwesomeIcon icon={faUser}/></a><span>Iniciar Sesión</span></button>
          )}
