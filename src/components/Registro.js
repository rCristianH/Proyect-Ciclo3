...
const Registro = () => {
    ...
    const buttonClick=()=>{
        ...
        if(valorNombre === '' && valorApellidos === '' && valorCorreo === '' && valorvalida === ''){
            ...
            return false;
                ...
                if(esValido == true){
                    if(valorCorreo == valorvalida){
                        ...
                        const datoEmail = newUser.Correo;
                        //console.log(datoEmail);
                        alert("Su registro ha sido exitosamente, esta a la espera de ser autorizado");
                        return datoEmail;
                    }
                    else{
    ...
    return(
        ...
        <div className={'Regis'}>
            <div className="campo">
                <label id="Nombre">Nombre<a className={valorNombre===''?'oblig':'oculto'}>*</a></label>
            ...
            <div className="campo">
                <label>Apellidos<a className={valorApellidos===''?'oblig':'oculto'}>*</a></label>
                <input className="textbox"
                type={'text'}
                name={'Apellidos'}
            ...
            <div className="campo">
                <label for='email'>Correo Electrónico<a className={valorCorreo===''?'oblig':'oculto'}>*</a></label>
                <input id={'email'} className="textbox"
                type={'email'}
                required
                name={'Correo'}
                value={valorCorreo}
            ...
            <div className="campo">
            <label>Validar Correo<a className={valorvalida===''?'oblig':'oculto'}>*</a></label>
            <input className="textbox"
            type={'text'}
            value={valorvalida}
            ...
            />
            <a className={valorCorreo===valorvalida?'oculto':'valida'}>El valor ingresado no coincide con su correo</a>
            </div>
            <div style={{textAlign:'center'}}>
                <button type={'button'} className="btnlink" onClick={buttonClick}>Registrar</button>
                <Link to={'/'}><button className="btnlink">Regresar</button></Link>
            </div>      
        </div>
        </section>
        );
